...
function loadPanelTripTypes() {
    ...
    axios.get('http://admin.nasser-byeeklu.com/site/all-tripTypes')
        .then((response) => {
...
function addTripType() {
    ...
    axios({
            method: 'post',
            url: 'http://admin.nasser-byeeklu.com/site/add-tripType',
            data: {
                name: name,
                deck: deck,
...
function updateTripType(id) {
    ...
    axios({
            method: 'put',
            url: 'http://admin.nasser-byeeklu.com/site/update-tripType',
            data: {
                _id: id,
                name: $('#tripTypeName').val(),
                deck: $('#tripTypeDeck').val(),
...
async function editTripTypeModal(id) {
    ...
    $('#tripTypeModal').modal('toggle')
    $('#tripTypeModal .loader-wrapper').css('display', 'block')
    let trip = await axios.get(`http://admin.nasser-byeeklu.com/site/tripType/${id}`)
    trip = trip.data
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                return axios({
                    method: 'delete',
                    url: 'http://admin.nasser-byeeklu.com/site/delete-tripType',
                    data: {
                        _id: _id,
                        _csrf: csrfToken
                    },
